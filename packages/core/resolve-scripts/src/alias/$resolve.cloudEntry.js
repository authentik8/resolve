    ...
    const handler = async (...args) => {
      try {
        if(!global.initPromise) {
          ...
          global.serverAssemblies = interopRequireDefault(require('$resolve.serverAssemblies')).default
          global.cloudEntry = interopRequireDefault(require('resolve-runtime/lib/cloud_entry')).default
